...
public class Mapa extends JPanel{
    ...
    public static final Color AGENT = new Color(255,255,0);
    ...
    public void escondeAgentes(HashMap<AID,Posicao> ags) {
        for (Posicao p :  ags.values()) {
            if (this.terrainGrid[p.getCordX()][p.getCordY()] != this.ABAST && 
            	this.terrainGrid[p.getCordX()][p.getCordY()] != this.COMB) {
            		this.terrainGrid[p.getCordX()][p.getCordY()] = this.CITY;
            }
        }
        frame.add(this);
        frame.pack();
    ...
    public void escondeIncendios(List<Posicao> posicoes){
    ...
    public void updateIncendios(List<Posicao> posicoes) { //nao servia para remover pq o laranja ficava na mesma
